...
public class VirtualPetApp {
    ...
    public static void main(String[] arg) {
        ...
        virtualpetsamok.VirtualPetShelter RCShelter = new virtualpetsamok.VirtualPetShelter();
        ...
        while (true) {
            if (RCShelter.getLitterBox() >= 100) {
                ...
                for (VirtualPet pet : RCShelter.pets()) {
            ...
            for (VirtualPet currentPet : RCShelter.pets()) {
